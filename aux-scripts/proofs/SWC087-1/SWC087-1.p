...
- <A HREF="http://www.cs.miami.edu/~tptp/cgi-bin/SystemOnTPTP?TPTPProblem=SWC087-1" TARGET="_blank">Solve Problem</A>
</CENTER><HR>
<pre>
%--------------------------------------------------------------------------
...
% Rating   : 0.67 v6.4.0, 0.73 v6.3.0, 0.64 v6.2.0, 0.80 v6.1.0, 0.93 v6.0.0, 0.90 v5.5.0, 1.00 v5.0.0, 0.93 v4.1.0, 1.00 v2.7.0, 0.92 v2.6.0, 1.00 v2.5.0, 0.89 v2.4.0
% Syntax   : Number of clauses     :  197 (  35 non-Horn;  60 unit; 154 RR)
%            Number of atoms       :  648 ( 110 equality)
