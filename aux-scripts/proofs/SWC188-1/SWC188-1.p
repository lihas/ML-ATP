...
- <A HREF="http://www.cs.miami.edu/~tptp/cgi-bin/SystemOnTPTP?TPTPProblem=SWC188-1" TARGET="_blank">Solve Problem</A>
</CENTER><HR>
<pre>
%--------------------------------------------------------------------------
...
% Rating   : 0.47 v6.3.0, 0.36 v6.2.0, 0.50 v6.1.0, 0.86 v6.0.0, 0.80 v5.5.0, 0.90 v5.3.0, 0.94 v5.0.0, 0.93 v4.1.0, 1.00 v4.0.1, 0.82 v3.7.0, 0.80 v3.5.0, 0.82 v3.4.0, 0.83 v3.3.0, 0.79 v3.2.0, 0.85 v3.1.0, 1.00 v2.4.0
% Syntax   : Number of clauses     :  205 (  41 non-Horn;  66 unit; 162 RR)
%            Number of atoms       :  638 ( 114 equality)
...
% Comments : Created by CNF conversion from SWC188+1
%--------------------------------------------------------------------------
