...
<head>
<title>TPTP Problem File: SWC202-1.p</title>
<meta name="ROBOTS" content="NOINDEX,NOFOLLOW" />
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
</head>
<body>
<HR><CENTER>
<H2>TPTP Problem File: SWC202-1.p</H2><A HREF=SeeTPTP?Category=Solutions&Domain=SWC&File=SWC202-1>View Solutions</A>
- <A HREF="http://www.cs.miami.edu/~tptp/cgi-bin/SystemOnTPTP?TPTPProblem=SWC202-1" TARGET="_blank">Solve Problem</A>
</CENTER><HR>
<pre>
%--------------------------------------------------------------------------
% File     : SWC202-1 : TPTP v6.4.0. Released v2.4.0.
...
% Status   : Unknown
% Rating   : 1.00 v2.4.0
% Syntax   : Number of clauses     :  201 (  33 non-Horn;  64 unit; 158 RR)
%            Number of atoms       :  632 ( 108 equality)
%            Maximal clause size   :   10 (   3 average)
%            Number of predicates  :   20 (   0 propositional; 1-2 arity)
%            Number of functors    :   56 (   9 constant; 0-2 arity)
%            Number of variables   :  335 (  49 singleton)
%            Maximal term depth    :    5 (   1 average)
% SPC      : CNF_UNK_RFO_SEQ_NHN

% Comments : Created by CNF conversion from SWC202+1
%--------------------------------------------------------------------------
