...
- <A HREF="http://www.cs.miami.edu/~tptp/cgi-bin/SystemOnTPTP?TPTPProblem=SWC067%2B1" TARGET="_blank">Solve Problem</A>
</CENTER><HR>
<pre>
%--------------------------------------------------------------------------
...
% Status   : Theorem
% Rating   : 0.40 v6.4.0, 0.46 v6.3.0, 0.50 v6.2.0, 0.56 v6.1.0, 0.60 v6.0.0, 0.65 v5.5.0, 0.59 v5.4.0, 0.61 v5.3.0, 0.63 v5.2.0, 0.60 v5.1.0, 0.62 v5.0.0, 0.54 v4.1.0, 0.52 v4.0.1, 0.61 v4.0.0, 0.58 v3.7.0, 0.60 v3.5.0, 0.58 v3.3.0, 0.50 v3.2.0, 0.45 v3.1.0, 0.67 v2.6.0, 0.50 v2.5.0, 0.33 v2.4.0
