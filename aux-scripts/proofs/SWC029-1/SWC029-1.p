...
- <A HREF="http://www.cs.miami.edu/~tptp/cgi-bin/SystemOnTPTP?TPTPProblem=SWC029-1" TARGET="_blank">Solve Problem</A>
</CENTER><HR>
<pre>
%--------------------------------------------------------------------------
...
% Rating   : 0.33 v6.4.0, 0.27 v6.3.0, 0.18 v6.2.0, 0.40 v6.1.0, 0.43 v6.0.0, 0.50 v5.5.0, 0.75 v5.4.0, 0.70 v5.3.0, 0.67 v5.2.0, 0.62 v5.1.0, 0.65 v5.0.0, 0.57 v4.1.0, 0.54 v4.0.1, 0.55 v3.7.0, 0.40 v3.5.0, 0.45 v3.4.0, 0.58 v3.3.0, 0.43 v3.2.0, 0.46 v3.1.0, 0.45 v2.7.0, 0.58 v2.6.0, 0.44 v2.5.0, 0.67 v2.4.0
% Syntax   : Number of clauses     :  200 (  34 non-Horn;  60 unit; 157 RR)
%            Number of atoms       :  628 ( 112 equality)
...
% Comments : Created by CNF conversion from SWC029+1
%--------------------------------------------------------------------------
