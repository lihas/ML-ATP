...
- <A HREF="http://www.cs.miami.edu/~tptp/cgi-bin/SystemOnTPTP?TPTPProblem=SWC197-1" TARGET="_blank">Solve Problem</A>
</CENTER><HR>
<pre>
%--------------------------------------------------------------------------
...
% Rating   : 0.67 v6.3.0, 0.64 v6.2.0, 0.80 v6.1.0, 0.93 v6.0.0, 0.80 v5.5.0, 0.95 v5.4.0, 0.90 v5.3.0, 0.94 v5.0.0, 0.93 v4.1.0, 1.00 v4.0.1, 0.91 v3.7.0, 0.90 v3.5.0, 0.91 v3.4.0, 0.92 v3.3.0, 0.93 v3.2.0, 1.00 v2.4.0
...
% Comments : Created by CNF conversion from SWC197+1
%--------------------------------------------------------------------------
...
<A NAME="co1_13"></A>cnf(co1_13,negated_conjecture,
    ( app(app(app(app(sk7,cons(sk5,nil)),sk9),cons(sk6,nil)),sk8) = sk1 )).
