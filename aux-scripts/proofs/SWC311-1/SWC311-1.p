...
- <A HREF="http://www.cs.miami.edu/~tptp/cgi-bin/SystemOnTPTP?TPTPProblem=SWC311-1" TARGET="_blank">Solve Problem</A>
</CENTER><HR>
<pre>
%--------------------------------------------------------------------------
...
% Rating   : 0.40 v6.4.0, 0.33 v6.3.0, 0.45 v6.2.0, 0.80 v6.1.0, 0.86 v6.0.0, 0.90 v5.5.0, 0.95 v5.3.0, 1.00 v5.2.0, 0.94 v5.0.0, 0.93 v4.1.0, 0.92 v4.0.1, 1.00 v4.0.0, 0.91 v3.7.0, 1.00 v2.4.0
% Syntax   : Number of clauses     :  197 (  34 non-Horn;  60 unit; 154 RR)
%            Number of atoms       :  638 ( 115 equality)
...
% Comments : Created by CNF conversion from SWC311+1
%--------------------------------------------------------------------------
