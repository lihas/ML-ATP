...
- <A HREF="http://www.cs.miami.edu/~tptp/cgi-bin/SystemOnTPTP?TPTPProblem=SWC211-1" TARGET="_blank">Solve Problem</A>
</CENTER><HR>
<pre>
%--------------------------------------------------------------------------
...
% Rating   : 0.47 v6.4.0, 0.40 v6.3.0, 0.36 v6.2.0, 0.60 v6.1.0, 0.57 v6.0.0, 0.70 v5.5.0, 0.85 v5.3.0, 0.89 v5.2.0, 0.81 v5.1.0, 0.82 v5.0.0, 0.79 v4.1.0, 0.77 v4.0.1, 0.82 v4.0.0, 0.64 v3.7.0, 0.50 v3.5.0, 0.64 v3.4.0, 0.67 v3.3.0, 0.64 v3.2.0, 0.69 v3.1.0, 0.82 v2.7.0, 0.83 v2.6.0, 0.89 v2.4.0
% Syntax   : Number of clauses     :  195 (  33 non-Horn;  62 unit; 152 RR)
%            Number of atoms       :  618 ( 104 equality)
...
% Comments : Created by CNF conversion from SWC211+1
%--------------------------------------------------------------------------
