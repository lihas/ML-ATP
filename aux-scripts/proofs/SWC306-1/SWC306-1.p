...
- <A HREF="http://www.cs.miami.edu/~tptp/cgi-bin/SystemOnTPTP?TPTPProblem=SWC306-1" TARGET="_blank">Solve Problem</A>
</CENTER><HR>
<pre>
%--------------------------------------------------------------------------
...
% Syntax   : Number of clauses     :  204 (  39 non-Horn;  67 unit; 161 RR)
%            Number of atoms       :  629 ( 109 equality)
...
% Comments : Created by CNF conversion from SWC306+1
%--------------------------------------------------------------------------
