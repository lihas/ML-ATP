...
- <A HREF="http://www.cs.miami.edu/~tptp/cgi-bin/SystemOnTPTP?TPTPProblem=SWC331-1" TARGET="_blank">Solve Problem</A>
</CENTER><HR>
<pre>
%--------------------------------------------------------------------------
...
% Rating   : 0.13 v6.3.0, 0.18 v6.2.0, 0.10 v6.1.0, 0.36 v6.0.0, 0.30 v5.5.0, 0.70 v5.4.0, 0.65 v5.3.0, 0.67 v5.2.0, 0.56 v5.1.0, 0.53 v5.0.0, 0.43 v4.1.0, 0.38 v4.0.1, 0.27 v4.0.0, 0.18 v3.7.0, 0.10 v3.5.0, 0.27 v3.4.0, 0.25 v3.3.0, 0.21 v3.2.0, 0.15 v3.1.0, 0.45 v2.7.0, 0.58 v2.6.0, 0.44 v2.5.0, 0.56 v2.4.0
% Syntax   : Number of clauses     :  197 (  33 non-Horn;  63 unit; 154 RR)
%            Number of atoms       :  622 ( 105 equality)
...
% Comments : Created by CNF conversion from SWC331+1
%--------------------------------------------------------------------------
