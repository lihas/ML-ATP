...
<head>
<title>TPTP Problem File: SWC196-1.p</title>
<meta name="ROBOTS" content="NOINDEX,NOFOLLOW" />
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
</head>
<body>
<HR><CENTER>
<H2>TPTP Problem File: SWC196-1.p</H2><A HREF=SeeTPTP?Category=Solutions&Domain=SWC&File=SWC196-1>View Solutions</A>
- <A HREF="http://www.cs.miami.edu/~tptp/cgi-bin/SystemOnTPTP?TPTPProblem=SWC196-1" TARGET="_blank">Solve Problem</A>
</CENTER><HR>
<pre>
%--------------------------------------------------------------------------
% File     : SWC196-1 : TPTP v6.4.0. Released v2.4.0.
...
% Comments : Created by CNF conversion from SWC196+1
%--------------------------------------------------------------------------
...
<A NAME="co1_16"></A>cnf(co1_16,negated_conjecture,
    ( app(app(app(app(sk8,cons(sk6,nil)),sk10),cons(sk7,nil)),sk9) = sk1 )).
