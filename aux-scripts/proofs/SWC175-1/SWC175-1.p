...
- <A HREF="http://www.cs.miami.edu/~tptp/cgi-bin/SystemOnTPTP?TPTPProblem=SWC175-1" TARGET="_blank">Solve Problem</A>
</CENTER><HR>
<pre>
%--------------------------------------------------------------------------
...
% Syntax   : Number of clauses     :  202 (  33 non-Horn;  69 unit; 159 RR)
%            Number of atoms       :  628 ( 106 equality)
...
% Comments : Created by CNF conversion from SWC175+1
%--------------------------------------------------------------------------
