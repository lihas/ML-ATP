...
- <A HREF="http://www.cs.miami.edu/~tptp/cgi-bin/SystemOnTPTP?TPTPProblem=SWC154-1" TARGET="_blank">Solve Problem</A>
</CENTER><HR>
<pre>
%--------------------------------------------------------------------------
...
% Status   : Unknown
% Rating   : 1.00 v2.4.0
% Syntax   : Number of clauses     :  202 (  33 non-Horn;  67 unit; 159 RR)
%            Number of atoms       :  630 ( 103 equality)
...
% Comments : Created by CNF conversion from SWC154+1
%--------------------------------------------------------------------------
